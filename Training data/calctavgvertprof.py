...
wc_tavgfields = np.mean(np.array(a['wc'][tstart:tend,kgc_edge:khend,jgc:jend,igc:iend]) * ustar, axis=(0,2,3))
...
wc_tstdfields = np.std(np.array(a['wc'][tstart:tend,kgc_edge:khend,jgc:jend,igc:iend]) * ustar, axis=(0,2,3))
#
