...
def _calculate_strain2(strain2,mlen,u,v,w,igc,jgc,kgc_center,iend,jend,kend,xgc,ygc,zgc,xhgc,yhgc,zhgc):
    '''Calculates the squared strain rate tensor and mixing lengths required for the Smagorinksy sub-grid model. \\
            ...
            NOTE2: xgc, ygc, zgc should be numpy arrays with the coordinates in each direction with ghost cells; they are used to calculate dx, dy, and dz. \\
            NOTE3: the squared strain rate is calculated at the grid centers. \\
            NOTE4: Assumes periodic BC in horizontal directions and no-slip BC in the vertical.'''
