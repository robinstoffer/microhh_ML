...
#        raise TypeError("Specified half channel width should be either a float or integer.")
    ...
    mvisc_ref = float(a['mvisc'][:]) #QUICK AND DIRTY: use molecular viscosity that is not normalized for quick checks
    ...
    for t in range(nt):
        ...
        strain2, mlen = _calculate_strain2(strain2,mlen,uc_singlefield,vc_singlefield,wc_singlefield,igc,jgc,kgc_center,iend,jend,kend,xgc,ygc,zgc,xhgc,yhgc,zhgc,utau_ref,mvisc_ref)
