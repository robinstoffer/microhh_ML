# NOTE: one small change in the naming of the ops compared to the original script (RS)!!!
...
def import_to_tensorboard(model_dir, log_dir):
  ...
  with session.Session(graph=ops.Graph()) as sess:
    with gfile.GFile(model_dir, "rb") as f:
      ...
      importer.import_graph_def(graph_def, name='') #NOTE: here name has been added to change the naming of the ops! (RS)
