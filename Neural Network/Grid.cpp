...
Grid::Grid(std::string grid_filenc, bool testing)
{
	// Store used setting for testing
	m_testing = testing;

	// Depending on whether or not the grid is instantiated in test mode, either hard-code the grid information or read it from a netCDF-file.
	if (testing)
	{
	...
	else //Read grid information from file
	{
